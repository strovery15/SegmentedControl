...
extension Notification.Name {
    static public let demo = Notification.Name("demo")
}
//
//
//
...
extension TabPageViewController {
    ...
    fileprivate func createButton() {
        ...
        let systemImage = UIImage(systemName: "folder.fill.badge.plus", withConfiguration: symbolConfiguration)
        button.setImage(systemImage, for: .normal)
        button.addTarget(self, action: #selector(ButtonAction(_:)), for: .touchUpInside)
        view.addSubview(button)
        button.translatesAutoresizingMaskIntoConstraints = false
        button.topAnchor.constraint(equalTo: view.safeAreaLayoutGuide.topAnchor).isActive = true
        button.widthAnchor.constraint(equalToConstant: option.tabHeight).isActive = true
        button.rightAnchor.constraint(equalTo: view.rightAnchor).isActive = true
        button.heightAnchor.constraint(equalToConstant: option.tabHeight).isActive = true
    }
    ...
    fileprivate func configuredTabView() -> TabView {
        ...
        tabView.rightAnchor
            .constraint(equalTo: view.rightAnchor, constant: -option.tabHeight).isActive = true
